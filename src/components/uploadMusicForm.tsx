    ...
    <div className="container w-3/4 min-w-[1393px] bg-gray-800/80 rounded-md flex justify-center">
      <div>
        ...
        <div className="flex flex-row justify-center mb-6">
          <div
            className={`bg-blue-400 w-5 h-5 m-1 rounded-full ${
              fileSelected ? "bg-gray-100" : ""
            }`}
          ></div>
          <div
            className={`bg-gray-400 w-5 h-5 m-1 rounded-full ${
              fileSelected ? "bg-gray-100" : ""
            }`}
          ></div>
        </div>
        <div className="flex flex-row w-4/5">
          <div
            className={`flex flex-col min-w-[648px] min-h-[410px] rounded-lg border-dashed border-2 border-gray-400 ${
              fileSelected ? "bg-gray-100" : "bg-pink-500"
            }`}
          >
            <label htmlFor="dropzone-file" className="cursor-pointer w-full h-full">
              <div
                ...
                <ImMusic className="fill-blue-900 w-16 h-16 m-4" />
        ...
        <div className="flex justify-end">
          <button
            className="user-form-button w-32 my-8 text-blue-900"
            onClick={() => {
